...
namespace Joomla\Component\Form\Administrator\Extension;
 ...
 * @since  6.0.0
 */
class FormComponent extends MVCComponent implements BootableExtensionInterface, RouterServiceInterface
{
